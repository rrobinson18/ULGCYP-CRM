...
class SignUpForm(UserCreationForm):
    ...
    def __init__(self, *args: Any, **kwargs):
        ...
        self.fields['password1'].widget.attrs['placeholder'] =  'form-control'   
        ...
        self.fields['password2'].widget.attrs['placeholder'] =  'form-control'   
        self.fields['password2'].label =  ''   
        self.fields['password2'].help_text =  '<span class="form-text text-muted"><small>Enter the same password as before, for verfiication</small></span>'   
